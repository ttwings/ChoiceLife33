...
signal max_mp_changed
signal current_mp_changed
signal max_sp_changed
signal current_sp_changed
signal max_exp_changed
signal current_exp_changed
signal max_level_changed
signal current_level_changed
signal max_hp_rate_changed
signal current_hp_rate_changed
signal max_mp_rate_changed
signal current_mp_rate_changed
signal max_sp_rate_changed
signal current_sp_rate_changed
signal max_exp_rate_changed
signal current_exp_rate_changed
signal max_level_rate_changed
signal current_level_rate_changed

signal get_hurt(amount, type,from)
signal dead(killed_by)
...
export(float) var attack_distance = 1.0
export(float) var attack_power = 1.0

export(int) var max_hp = 10 setget _set_max_hp
export(int) var current_hp = 0 setget _set_current_hp
export(int) var max_mp = 10 setget _set_max_mp
export(int) var current_mp = 0 setget _set_current_mp
export(int) var max_sp = 10 setget _set_max_sp
export(int) var current_sp = 0 setget _set_current_sp
export(int) var max_exp = 10 setget _set_max_exp
